...
if (Config.WORKTYPE == 'private') {
    ...
    Trex.addrex({pattern: 'mp3', fromMe: true,  deleteCommand: false, desc: Lang.MP4TOAUDİO_DESC}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('Black.mp3')
            .on('end', async () => {
                await message.client.sendMessage(message.jid, fs.readFileSync('Black.mp3'), MessageType.audio, {mimetype: Mimetype.mp4Audio, ptt: false});
            });
    ...
    Trex.addrex({pattern: 'photo', fromMe: true,  deleteCommand: false, desc: Lang.STİCKER_DESC}, (async (message, match) => {   
        ...
        ffmpeg(location)
            ...
            .save('Black.jpg')
            .on('end', async () => {
                await message.client.sendMessage(message.jid, fs.readFileSync('Black.jpg'), MessageType.image, {quoted: message.data}, {mimetype: Mimetype.jpg , Caption : '❰🍁🔱  BLACK BOT  🔱🍁❱'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
}
